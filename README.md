...
**Data protection and encryption requirements for AI agents — classify data and enforce encryption standards.**

ENCRYPT.md is a plain-text Markdown file you place in the root of any AI agent project. It defines data classification levels (critical, sensitive, internal, public), encryption requirements at rest and in transit, secrets handling rules, data retention and purge policies, transmission rules, and audit logging — so your agent never transmits credentials in plaintext or logs protected data.

- Full specification: [encrypt.md](https://encrypt.md)
- AI-readable: [llms.txt](https://encrypt.md/llms.txt)
- License: MIT
...
Copy [`ENCRYPT.md`](./ENCRYPT.md) into your project root:
...
ENCRYPT.md is part of a twelve-file open standard for AI agent safety, quality, and accountability:
